...
const LexChat = (props) => {
  ...
  AWS.config.credentials = new AWS.CognitoIdentityCredentials({IdentityPoolId: props.IdentityPoolId});
...
onLoad();
if(props.sessionAttributes && props.sessionAttributes !== prevState.sessionAttributes) {
  state.sessionAttributes = {...state.sessionAttributes, ...props.sessionAttributes}
}
...
function showResponse(lexResponse) {
  ...
  if (lexResponse.message) {
    responseParagraph.appendChild(document.createTextNode(lexResponse.message)); 
  }
  if (lexResponse.dialogState === "ReadyForFulfillment") {
    responseParagraph.appendChild(document.createTextNode("Ready for fulfillment"));
  }
let spacer = document.createElement('div');
spacer.className = "conversationSpacer";
